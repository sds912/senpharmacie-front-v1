      ...
      <div className='d-flex'>
        ...
        <div className='body mx-3 p-4'>
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-8">
                <img style={{ width: 100, height: 100 }} src={"http://localhost:8000/images/" + pharmacieDetails.photo} className=" imagePharmaci" alt={pharmacieDetails.nom}></img>
              </div>
              <div class="col-sm-4">
                ...
                <h1>{pharmacieDetails.quartier_id}</h1>
                <h1>{pharmacieDetails.logitude}</h1>
                <h1>{pharmacieDetails.logitude}</h1>
                </div>
            </div>
          </div>
